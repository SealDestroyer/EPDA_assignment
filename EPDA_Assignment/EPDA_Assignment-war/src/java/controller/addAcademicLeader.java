    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                // Create new user record with validated data
                ...
                // Update the academic leader ID counter for next registration
                myUserIDFacade.updateCurrentUserId(userID, "AcademicLeader");

                // Display success message and redirect to view page
                out.println("<script type='text/javascript'>");
                out.println("alert('Academic Leader Added Successfully!');");
