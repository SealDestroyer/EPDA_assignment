...
@WebServlet(name = "ALProfile", urlPatterns = {"/ALProfile"})
public class ALProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("edit".equals(action)) {
                ...
                MyAcademicLeader al = myAcademicLeaderFacade.find(userID);
            ...
            // fallback
            response.sendRedirect("ALProfile?action=edit");
    ...
    public String getServletInfo() {
        return "Academic Leader Profile servlet";
    }
}
