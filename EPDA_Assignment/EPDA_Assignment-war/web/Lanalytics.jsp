        ...
        <script>
            ...
            function initAnalytics() {
                ...
                function loadModules(keepSelection) {
                    fetch(BASE + "/LAnalytics?action=modules", {cache: "no-store"})
                            ...
                            .then(list => {
                                ...
                                // ✅ if lecturer already selected a module before,
                                // check if it still exists in current module list
                ...
                function refreshChart() {
                    // ✅ every refresh, also re-check module list (so selection disappears if reassigned)
                    loadModules(true);
